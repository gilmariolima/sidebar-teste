...
const textoSide = document.querySelectorAll(".textoSide")
...
btnMenu.addEventListener("click", function(){
    if(sidebar.classList.contains("ativa")){
        ...
        textoSide.forEach(item=>{item.style.display = "none"})
        ...
        setTimeout(function(){ textoSide.forEach(item => item.style.display = "flex");}, 200);
    }
})
